...
{{% alert note %}}
Material last updated on **17 December, 2021**. Teaching material is available in English, under request ( some material is already available {{% staticref "teaching/computermusic19/ComputerMusic-EnglishMat-2019-EN.pdf" %}}here{{% /staticref %}}).
{{% /alert %}}

* Diario delle lezioni
  * **[UPDATED]** {{% staticref "teaching/audioprocessing21/AudioProcessing-Agenda-2021-IT.pdf" %}}Diario aggiornato il 17/12/21{{% /staticref %}}
* Progetti Opzionali
...
* Slide
  ...
  * **[UPDATED]** {{% staticref "teaching/audioprocessing21/AudioProcessing-Slide-16-2021-IT.pdf" %}}Lez 16 - Formati 1{{% /staticref %}}
  * **[NEW]** {{% staticref "teaching/audioprocessing21/AudioProcessing-Slide-17-2021-IT.pdf" %}}Lez 17 - Formati 2{{% /staticref %}}
* Questionari e Autovalutazioni
  ...
  * **[NEW]** [Autovalutazione 16 - Formati 1](https://docs.google.com/forms/d/e/1FAIpQLScizDBx9BQ5Rxdwc_B8Aw_M76BkiEG9_U87k28aHUhvNhTJug/viewform?usp=sf_link)
